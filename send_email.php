...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['message'])) {
        ...
        try {
            ...
            $mail->addAddress('cs.iwongwifi@iwingwifi.online', 'cs Iwonks WiFi'); // Ubah ke alamat email dan nama penerima
...
<body>
    ...
    <div class="container">
        <h2>Kontak I Net</h2>
        <div class="message">
            <p>Selamat datang di halaman kontak I Net. Kami siap membantu Anda dengan layanan internet kami yang handal dan stabil. Jangan ragu untuk menghubungi kami melalui alamat email <a href="mailto:info@rtrwnet.com">cs@iwongwifi.online</a> untuk pertanyaan atau bantuan terkait layanan kami.</p>
